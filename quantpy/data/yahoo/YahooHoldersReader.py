...
class YahooHoldersReader(BaseReader):

    def __init__(self, symbols, institutions=True, funds=True, insiders=True,
                 majors_breakdown=False, insider_transactions=False,
